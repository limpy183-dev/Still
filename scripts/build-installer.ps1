...
powershell -NoProfile -STA -Command "Add-Type -AssemblyName PresentationFramework; [Windows.Markup.XamlReader]::Load([IO.File]::OpenRead('$src\Setup.xaml')) | Out-Null"
...
$sources = @("$src\Setup.cs", "$work\Version.cs")
